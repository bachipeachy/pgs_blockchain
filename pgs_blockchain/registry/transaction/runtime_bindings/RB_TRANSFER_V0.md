...
```yaml
rb_code: RB_TRANSFER_V0
version: v0
governed_by: fb.topology::CONSTITUTION_RUNTIME_BINDING_V0

core:
  summary: Runtime binding for TRANSFER transaction workflow
  description: Binds capability side effects to concrete runtime implementations for TRANSFER (ENDUSER). Includes actor registry for ownership check.
