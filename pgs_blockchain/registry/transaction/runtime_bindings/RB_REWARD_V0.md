...
```yaml
rb_code: RB_REWARD_V0
version: v0
governed_by: fb.topology::CONSTITUTION_RUNTIME_BINDING_V0

core:
  summary: Runtime binding for REWARD transaction workflow
  description: Binds capability side effects to concrete runtime implementations for REWARD (SYSTEM). CS_REGISTRY_V0 provides tx dedup for CC_PERSIST_MEMPOOL_TX_V0.
